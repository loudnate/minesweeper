 ...
 * @private
 */
minesweeper.GameController.prototype.boardSize_ = 8;
 ...
 * @private
 */
minesweeper.GameController.prototype.mineCount_ = 10;
 ...
 * @private
 */
minesweeper.GameController.prototype.prerender_ = function() {
 ...
 * @private
 */
minesweeper.GameController.prototype.loadConfig_ = function() {
 ...
 * @private
 */
minesweeper.GameController.prototype.bindConfig_ = function() {
 ...
 */
minesweeper.GameController.prototype.startGame = function() {
	this.game_ =
 ...
 * @private
 */
minesweeper.GameController.prototype.renderBoard_ = function() {
	var boardHtml = '';
 ...
 * @private
 */
minesweeper.GameController.prototype.getTile_ = function(row, col) {
 ...
 * @private
 */
minesweeper.GameController.prototype.getDisplayClass_ = function(tile) {
 ...
 * @private
 */
minesweeper.GameController.prototype.setTile_ = function(row, col, tile) {
 ...
 * @private
 */
minesweeper.GameController.prototype.updateBoard_ = function(board) {
 ...
 * @private
 */
minesweeper.GameController.prototype.handleBoardClick_ = function(evt) {
	evt.preventDefault();
 ...
 * @private
 */
minesweeper.GameController.prototype.success_ = function() {
 ...
 * @private
 */
minesweeper.GameController.prototype.failure_ = function() {
	this.updateBoard_(this.game_.mineBoard);
